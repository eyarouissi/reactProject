...
export function SidebarCandidate(props) {
  ...
  return (
    <aside
      ...
      className={
        hideside
          ? 'transition-width  fixed top-0 left-0 z-20 flex  h-full w-24 flex-shrink-0 flex-col  duration-75 '
          : 'transition-width  fixed top-0 left-0 z-20 flex  h-full w-64  flex-shrink-0 flex-col  duration-75    first-letter:lg:flex'
      }
    >
      <div
        className={
          hideside
            ? ' relative  flex min-h-0 min-w-fit flex-1 flex-col border-r border-gray-200 bg-white pt-5'
            : ' relative  flex min-h-0 min-w-fit flex-1 flex-col border-r border-gray-200 bg-white pt-5 '
        }
      >
            ...
            <ul className="mt-16 space-y-2 pb-2">
              ...
              <li>
                <a className="group flex items-center rounded-lg p-2 text-base font-normal text-gray-900 hover:bg-gray-100">
                  {hideside ? (
                    <div className=" flex h-10 w-10 justify-center rounded-md bg-blue-50">
                      <FaPen color="navy" className=" mt-2.5" size={20}></FaPen>
                    </div>
                  ) : (
                    <div className="flex flex-row">
                      <div className=" flex h-10 w-10 justify-center rounded-md bg-blue-50">
