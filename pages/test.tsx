...
export default function leadingPage() {
  ...
  const [Questions, setQuestions] = useState([
    ...
    const handleSubmit = () => {
      ...
      setQuestions([{interviewQuestion : Question, Recording:"2min", autoStart:"No"}, ...Questions])
      ...
      >
        ...
        <div className=" max-w-md">
           ...
           {({ open }) => (
            ...
            >
              <Popover.Panel className="absolute z-20 center  -ml-12 py-6 w-screen items-center " style={{position: "fixed",top: "50%",left: "50%",transform: "translate(-50%, -50%)",width:"50%"}}>
                <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                  
                  <div className="p-6 bg-gray-50">
                    <a><h1 className='font-medium text-lg text-cyan-900 '>Type your question</h1>
                  <input className="mt-4 shadow appearance-none border-2 rounded-md  border-purple-600 w-full py-2 px-20 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="input"  name="input" type="text" 
                   value={Question}
              ...
              <div className=" mt-2 mx-4 flex text-slate-700 cursor-pointer text-sm justify-center font-normal ">
               <h1>Recording time</h1>
               <input type="range" name="time" min="1" max="100" defaultValue="10" className="w-full mx-6 h-2 bg-purple-600 mt-2  appearance-none" />
              </div>
    ...
    <label className="form-check-label inline-block text-gray-800" htmlFor="inlineRadio20">No</label>
        ...
        <div className=" mt-1 flex h-6 w-9 cursor-pointer justify-center rounded-md ">
             <BsFillCameraVideoFill className="text-purple-600 -ml-6"/>
              ...
              <div className="-mt-2 mx-20 flex flex-row items-start ">
                    
                      
                      <Toggle backgroundcolor={" bg-purple-600"} element={element} list={selectedQuestion} className="mx-2" name="toggle" icon={undefined}  />
