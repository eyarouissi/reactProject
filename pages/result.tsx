  ...
  useLayoutEffect(() => {
    {
      if (candidate.behaviorScore < 50) {
        setcolorbe(['red', 'lightgray'])
      } else {
        if (candidate.behaviorScore < 70) setcolorbe(['yellow', 'lightgray'])
        else setcolorbe(['green  ', 'lightgray'])
      }
      if (candidate.cvScore < 50) {
        setcolorcv(['red', 'lightgray'])
      } else {
        if (candidate.cvScore < 70) setcolorcv(['yellow', 'lightgray'])
        else setcolorcv(['green  ', 'lightgray'])
      }
      if (candidate.cognitiveScore < 50) {
        setcolorco(['red', 'lightgray'])
      } else {
        if (candidate.cognitiveScore < 70) setcolorco(['yellow', 'lightgray'])
        else setcolorco(['green  ', 'lightgray'])
      }
      if (candidate.technicalScore < 50) {
        setcolorte(['red', 'lightgray'])
      } else {
        if (candidate.technicalScore < 70) setcolorte(['yellow', 'lightgray'])
        else setcolorte(['green  ', 'lightgray'])
      }
      let colors = []
      technicaldata.map((a) => {
        if (a < 50) {
    ...
    datasets: [
      {
        ...
        hoverBackgroundColor: ['yellow', 'lightgray'],
      },
    ],
  }
  const databu = {
    ...
    datasets: [
      {
        ...
        hoverBackgroundColor: ['green', 'lightgray'],
      },
    ],
  }
  const dataSt = {
        ...
        <div className=" flex  min-w-max flex-col">
          <div className="flex flex-row justify-between  px-6  xl:px-8">
            <div className="flex min-w-max  flex-row overflow-auto">
              <a className="cursor-pointer text-base font-bold text-blue-900">
                Projects{' '}
              </a>
          ...
          <div className="flex flex-row place-self-end  px-6  xl:px-8">
            <div className="flex min-w-max cursor-pointer flex-row overflow-auto text-blue-400">
              <FcPrevious className="mt-1" />
              Previous candidate
            </div>
            <div className="mx-2 flex min-w-max cursor-pointer  flex-row overflow-auto text-blue-400">
              Next candidate
            ...
            <div className=" min-h-max  min-w-max rounded-lg bg-white p-2 shadow">
              <div className="grid min-h-fit grid-flow-col grid-cols-10 grid-rows-5 gap-0 ">
                <div className="col-span-2 row-span-6   h-4/6 bg-white">
                  ...
                  <div className="mx-2 mt-5 flex flex-row justify-center p-2">
                    Select
                    <Toggle element={''} list={''}
                      className="ml-2 mt-1"
                      name="toggle"
                          ...
                          <div className="  col-span-5 row-span-1  flex min-h-fit min-w-fit rounded-lg   bg-white  p-6 shadow-lg ">
                            <div className="flex flex-col">
                              ...
                              <div
                                className={
                                  hideSide
                                    ? 'mt-2 ml-4 w-[30rem]  font-sans text-sm'
                                    : 'mt-2 ml-4 w-[30rem]  text-justify font-sans text-sm'
                                }
                              >
                  ...
                  <>
                    <div className=" col-span-9 row-span-5  bg-white">
                      ...
                      <div className=" mb-0 -mt-2  min-h-fit   overflow-y-hidden rounded-tl-3xl bg-blue-50 shadow-inner  hover:overflow-y-auto">
                        <div className="grid grid-flow-col grid-cols-9 grid-rows-2 gap-10 p-10">
                          <div
                            className="col-span-7  col-start-2 row-span-1  flex h-96 min-h-fit min-w-fit rounded-lg
                          ...
                          >
                            <div className="flex flex-col">
                              <div className="flex flex-row">
                                ...
                                <span className="mt-1 ml-7 w-[32rem] text-justify text-base font-thin text-gray-900">
                                  {online.question1}
                                </span>
                              </div>
                              <div className="flex h-64 flex-row justify-between">
                                <div className=" mt-8 ml-5 h-full w-4/6 rounded-lg ">
                                  <ReactPlayer
                                    width="100%"
                                    height="100%"
                                    url={online.video1}
                                ...
                                <div className=" mt-8 ml-10 w-[12rem]">
                                  ...
                                  <textarea className="h-[8rem] w-[17rem] rounded-lg border-2 border-blue-100"></textarea>
                                </div>
                              </div>
                            </div>
                          </div>
                          <div className="col-span-7 col-start-2 row-start-2 flex      h-96     min-h-fit min-w-fit rounded-lg bg-white p-6 shadow-lg">
                            <div className="flex flex-col">
                              <div className="flex flex-row">
                                <BsQuestionCircleFill
                                  color="dodgerblue"
                          ...
                          <div className="col-span-7 col-start-2 row-start-3 flex      h-96     min-h-fit min-w-fit rounded-lg bg-white p-6 shadow-lg">
                            <div className="flex flex-col">
                              <div className="flex flex-row">
                                <BsQuestionCircleFill
                                  color="dodgerblue"
                          ...
                          <div className="col-span-7 col-start-2 row-start-4 flex      h-96     min-h-fit min-w-fit rounded-lg bg-white p-6 shadow-lg">
                            <div className="flex flex-col">
                              <div className="flex flex-row">
                                <BsQuestionCircleFill
                                  color="dodgerblue"
                              ...
                              <div className="flex h-64 flex-row justify-between">
                                ...
                                <div className=" mt-8 ml-10 w-[12rem]">
                                  ...
                                  <textarea className="h-[8rem] w-[17rem] rounded-lg border-2 border-blue-100 focus:border-2 focus:border-blue-500"></textarea>
                                </div>
                              </div>
                            </div>
                          </div>
                            ...
                            <div className="flex flex-col">
                              ...
                              >
                                <div className="col-start-1 flex flex-col">
                                  ...
                                  <div className="mt-14 w-32 text-center text-sm font-thin">
                                    Service Orientation
                                  </div>
                                </div>
                                <div className="col-start-2">
                                  ...
                                  <div className="mt-14 text-center text-sm font-thin">
                                    Sales Potential
                                  </div>
                                </div>
                                <div className="col-start-3">
                          ...
                          <div className=" col-span-6 row-span-2 mt-2 flex  min-h-fit min-w-fit rounded-lg   bg-white  p-6 shadow-lg ">
                            <div className="flex flex-col">
                              ...
                              <div className="grid-col-8 mt-10 grid grid-flow-col gap-10">
                                <div className="col-start-3">
                                  <div className=" w-32 text-center text-sm font-thin">
                          ...
                          <div className="col-span-3 col-start-7  row-span-1 row-start-1 flex  min-h-fit min-w-fit rounded-lg bg-white p-6  shadow-lg">
                            <div className="flex w-3/4 flex-col">
                              ...
                              <div className="mt-1 ml-4 flex flex-col justify-center">
                                <div className="mb-2 ml-1 flex flex-row text-sm font-thin">
                                  Expediant Thinker%
                                </div>
